...
def get_segment_Lk_dynamics(model: Model, dx_dt_front: float, dx_dt_back: float, dtheta_dt_front: float, dtheta_dt_back: float, left_barrier_type: str, right_barrier_type: str, is_rightmost_segment: bool, is_leftmost_segment: bool) -> float: # Get the rate of change of linking number for a DNA segment based on the angular velocities at its front and back
